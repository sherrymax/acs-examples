...
* Step 1: [Configure AWS Elastic Load Balancer](https://github.com/sherrymax/acs-examples/tree/master/acs-O365-integration#configure-aws-elastic-load-balancer)
* Step 2: [Configure O365 SPA](https://github.com/sherrymax/acs-examples/tree/master/acs-O365-integration#configure-o365-spa)
* Step 3: [Configure Alfresco Digital Workspace (ADW)](https://github.com/sherrymax/acs-examples/tree/master/acs-O365-integration#configure-alfresco-digital-workspace-adw-for-adporca-users)
