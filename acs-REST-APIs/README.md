...
* A set of Global Variables is <a href="assets/workspace.postman_globals.json" target="_top">available here</a>. Please import into Postman for seamless execution.
